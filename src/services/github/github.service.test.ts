...
export const mockCertificateKey = '--- CRETIFICATE PRIVATE ---'
export const mockCertificatePub = '--- CRETIFICATE PUBLIC ---'
...
describe('GithubService suit test', () => {
  ...
  it('should return id token', () => {
    ...
    expect(jwt.sign).toHaveBeenCalledWith(
      {
        iss: 'https://localhost',
        aud: mockGitHubClient.client_id
      },
      mockCertificateKey,
      {
        expiresIn: '1h',
